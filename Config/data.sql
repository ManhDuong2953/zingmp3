...
ALTER TABLE song 
ADD FOREIGN KEY (album_id) REFERENCES album (album_id) ON DELETE CASCADE ON UPDATE CASCADE,
ADD FOREIGN KEY (artist_id) REFERENCES `user` (id_user) ON DELETE CASCADE ON UPDATE CASCADE;


-- Thêm ràng buộc ngoại cho bảng album
ALTER TABLE album 
ADD FOREIGN KEY (artist_id) REFERENCES `user` (id_user) ON DELETE SET NULL ON UPDATE CASCADE;

-- Thêm ràng buộc ngoại cho bảng favorite_list
ALTER TABLE favorite_list 
ADD FOREIGN KEY (song_id) REFERENCES song (song_id) ON DELETE CASCADE ON UPDATE CASCADE,
ADD FOREIGN KEY (user_id) REFERENCES `user` (id_user) ON DELETE CASCADE ON UPDATE CASCADE;
