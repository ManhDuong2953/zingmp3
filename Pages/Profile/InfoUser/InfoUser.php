...
<html lang="en">
  <head>
    ...
    <link
      rel="shortcut icon"
      href="../../../Component/assets/logo_mobile.png"
      type="image/x-icon"
    />
    ...
    <div id="profile-main">
      ...
      <div class="profile-right">
        ...
        <div class="container-profile">
          <div class="profile-header">
            <div class="img-container">
              <img
                src="https://avatar-nct.nixcdn.com/playlist/2018/09/07/6/0/e/e/1536301824724_500.jpg"
                alt=""
              />
            </div>
        ...
        <div class="profile-content">
          <h1 class="update-infor-title">Chỉnh sửa thông tin cá nhân</h1>
          <form>
            <div class="infor-user-content">
                <div class="infor-text">
                  <div class="infor-text-detail">
                    <label for="name_account">Tên tài khoản</label
                    ><input
                      name="name_account"
                      type="text"
                      class="form-control name_account"
