...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="/ZingMP3/Component/PlayingBar/PlayingBar.css?v=1.0"
    />
    <link
      rel="stylesheet"
  ...
  <body>
        ...
        <div class="player_controls-left">
          <div class="player_controls-media">
            <div class="media_left">
              <img
                class="media-avatar"
                src="https://photo-resize-zmp3.zmdcdn.me/w94_r1x1_jpeg/avatars/5/d/a/9/5da92b54155ac844f9dac366057cbcde.jpg"
                alt=""
              />
            </div>
          ...
          <div class="player_bottom">
            ...
            <div class="playing_time-up2 progress-area">
              ...
              <div style="width: 0px; height: 0px">
                <audio
                  src="http://api.mp3.zing.vn/api/streaming/audio/ZUBEFEU7/320"
                  preload="auto"
    ...
    <audio
      ...
      hidden
      controls
      src="../../Component/assets/phequa.mp3"
    ></audio>
